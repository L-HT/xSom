...
calculateDelta <- function(inputMatrix, inputVector, naExist) {
    .Call('xSom_calculateDelta', PACKAGE = 'xSom', inputMatrix, inputVector, naExist)
}

calculateEuclidianDistances <- function(deltaMatrix, oldColumns) {
    .Call('xSom_calculateEuclidianDistances', PACKAGE = 'xSom', deltaMatrix, oldColumns)
}
...
matrixToCodebookMatrix <- function(matrix, xDim) {
    .Call('xSom_matrixToCodebookMatrix', PACKAGE = 'xSom', matrix, xDim)
}
